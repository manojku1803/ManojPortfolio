  ...
  return (
    <footer className='w-full text-center text-gray-300 bg-[#0a192f] md:pt-10 dark:bg-gray-300 dark:text-gray-800'>
        ...
        <div className='p-4'>
            <div className='mx-auto grid max-w-7xl grid-cols-2 gap-6 space-y-4 md:mx-2 md:grid-cols-2 '>
                ...
                <h5 className='mb-1 text-lg font-semibold'>
                    ...
                    <div className='flex gap-1.5 mt-2'>
                        ...
                        <a href='mailto:manojpradhan1803@gmail.com'>
            ...
            <p className='text-lg font-medium tracing-wider my-5'>Built with <span class="text-red-700 text-2xl">🧡</span> by Manoj.</p>
